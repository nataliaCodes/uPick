...
// Determines if the smart search is doing a book search
...
// Determines if the smart search is doing a product search
...
const searchMovie = (movie) => {
    ...
    return request(options, function (error, response, body) {
      ...
      if (error) console.log('movie API error', error);
  });
};
